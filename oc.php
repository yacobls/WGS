...
<div class="table-responsive">
    ...
    <button class="btn btn-primary mb-2" onclick="addRow()">Tambah</button>
...
function formatRupiah(angka) {
  ...
  function addRow() {
    var table = document.querySelector('.table-shopping');
    var newRow = table.insertRow();

    // Define the structure of a row
    newRow.innerHTML = `
      <td><input type="text" name="namabarang[]"></td>
      <td><input type="text" required name="qty[]"></td>
      <td><input type="text" name="satuan[]"></td>
      <td><input type="text" required name="price[]" oninput="updateTotalPrice(this)"></td>
      <td><input type="text" name="totalprice[]" readonly></td>
      <td><a href="#" class="close" data-dismiss="modal" aria-label="Close" onclick="deleteRow(this)">
