...
<div class="clearfix"></div>
 ...
 <div class="card-body">
    <h5 class="card-title text-center mb-3">TRACK BARANG</h5>
    <br>
...
// Ambil data dari tabel barangout dan perbarui stockbarangglobal
$query = "SELECT bo.kodeproduksi, mb.kodebarang, mb.namabarang, bo.serialnumber, mb.class
          FROM barangout bo
          JOIN masterbarang mb ON bo.namabarang = mb.namabarang";
...
if (mysqli_num_rows($result) > 0) {
    while($row = mysqli_fetch_assoc($result)) {
        ...
        // Perbarui tabel stockbarangglobal dengan data dari barangout
        $update_query = "UPDATE stockbarangglobal 
                        SET kodeproduksi='$kodeproduksi', kodebarang='$kodebarang', namabarang='$namabarang', serialnumber='$serialnumber', class='$class' 
                        WHERE namabarang='$namabarang'";
        mysqli_query($koneksi, $update_query);
    }
}
