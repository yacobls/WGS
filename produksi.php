...
$query = mysqli_query($koneksi, "SELECT max(kodeproduksi) as kodeproduksiTerbesar, max(nounit) as nounitTerbesar FROM produksi");
$data = mysqli_fetch_array($query);
$kodeproduksiTerbesar = $data['kodeproduksiTerbesar'];
$nounitTerbesar = $data['nounitTerbesar'];
$urutanKodeProduksi = (int) $kodeproduksiTerbesar + 1;
$urutanNounit = (int) $nounitTerbesar + 1;
$kodeproduksi = $urutanKodeProduksi;
$nounit = $urutanNounit;
...
<div class="clearfix"></div>
  ...
  <div class="row">
   <div class="col-12 col-lg-12">
     <div class="card">
      <div class="card-body">
              <h5 class="card-title text-center mb-3">Produksi</h5>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content bg-theme1 text-black">
      ...
      <div class="modal-body">
        <form id="tambahDataProduksiForm" action="simpanproduksi.php" method="POST">
...
<div class="row">
  ...
  <div class="col-md-6">
    <div class="form-group">
      ...
      <input type="text" readonly class="form-control" id="nounit" name="nounit" value="<?php echo $nounit ?>" required="required">
    </div>
  </div>
</div>
